...
n_tests_db    <- .count_tests("test-db.R")
n_tests_total <- n_tests_run + n_tests_tools + n_tests_utils + n_tests_db
...
|   └── testthat
|       ├── test-run.R    # Unit tests of run.R (`r n_tests_run` tests)
|       ├── test-tools.R  # Unit tests of tools.R (`r n_tests_tools` tests)
|       ├── test-utils.R  # Unit tests of utils.R (`r n_tests_utils` tests)
|       └── test-db.R     # Unit tests of db.R (`r n_tests_db` tests)
├── man
